...
The function `standardize_traits()` now finally has all it needs to complete its job. 

```{r, message=FALSE, warning=FALSE}

dataset1final <- standardize_traits(dataset1Std, traits1)
head(dataset1final)
