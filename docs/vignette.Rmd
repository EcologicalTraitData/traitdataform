...
head(subset(out3, trait == "feeding_niche"))
head(subset(out3, trait == "hibernation"))
...
```{r}
out1std <- standardize(out1, traits1)
...
write.csv(out4std, file = "traits_standardized.csv", map = )
...
```{r, meassage = FALSE}
out6taxtra <- standardize.traits(out6tax, traits6)
