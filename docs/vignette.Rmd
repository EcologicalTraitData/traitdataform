...
dataset1$author <- as.factor("Fons van der Plas")
dataset1$bibliographicCitation <- as.factor("van der Plas F, et al. (2017) Sensitivity of functional diversity metrics to sampling intensity. Methods in Ecology and Evolution 8(9): 1072-1080. https://doi.org/10.1111/2041-210x.12728")
dataset1$datasetName <- as.factor("Carabid Traits")
dataset1$license <- "http://creativecommons.org/publicdomain/zero/1.0/"
