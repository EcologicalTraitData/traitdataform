...
## merging traitdata tables

The merging of separate datasets can be done before or after the standardisation process, depending on the use case. Use cases of merging data are:
